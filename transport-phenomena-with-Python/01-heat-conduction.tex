...
\begin{figure}[H]
\centering\includegraphics[width=16cm]{plots/example-heat-transfer-in-a-rod-theory.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=12cm]{plots/example-heat-transfer-in-a-rod-analytic.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=12cm]{plots/example-heat-transfer-in-a-rod-FDM-n5.pdf}
\caption{Finite Difference Method numerical solution using $n=5$ equations.}
\label{fig:FDM-solution}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[width=12cm]{plots/example-heat-transfer-in-a-rod-FDM-n10.pdf}
