...
class Couette(FlowType):
    ...
    def __init__(self, boundaryVel=1, channelThickness=0.01, density=1000, viscosity=0.00089, fluidName="unknown"):
...
class Uniform(FlowType):
    ...
    def __init__(self, uniformVel=1, channelThickness=0.01, density=1000, viscosity=0.00089, fluidName="unknown"):
        super().__init__(channelThickness, density, viscosity, fluidName)
...
class Poiseuille(FlowType):
    ...
    def __init__(self, dpdx=-1, channelThickness=0.01, density=1000, viscosity=0.00089, fluidName="unknown"):
        super().__init__(channelThickness, density, viscosity, fluidName)
        self.dpdx = dpdx
